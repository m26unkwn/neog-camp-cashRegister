...
toggle.addEventListener("click", () => {
  ...
  if (darkMode) {
    ...
    root.style.setProperty("--color-primary", "#ff9ff3");
    root.style.setProperty("--color-secondary", " #ec46ba");
  } else {
    toggle.textContent = "⛅";
    root.style.setProperty("--color-primary", " #feca57");
    root.style.setProperty("--color-secondary", "#ff9f43");
  }
});
